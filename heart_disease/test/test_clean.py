...
class TestClean(unittest.TestCase):
    ...
    def test_impute_nan(self):
        """Test impute_nan function, 
        by checking the number of columns
        with NaN after cleaning the data.
        """
    ...
    def test_clean_all(self):
        ...
        with NaN and duplicated entries
        after cleaning the given test dataframe.
        """
        # create test data
        import pandas as pd
